...
with ftp_tests as (
    select * from (values
        (1, 82489018, 143, 2.69, '2025-11-01'::date, 'Standart 20 min', false),
        (2, 46046096, 185, 2.68, '2025-01-01'::date, 'Unknown', true),
        (3, 82489018, 156, 2.94, '2026-02-25'::date, 'Standart 20 min', true )
